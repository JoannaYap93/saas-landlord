    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="menu-title">Tenant</li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="{{ route('subdomain_add') }}">Add Tenant</a></li>
                            {{-- @endcan
                            @can('user_role_listing') --}}
                            <li><a href="{{ route('subdomain_listing') }}">Tenant Listing</a></li>
                            {{-- @endcan --}}
                        </ul>
                    </li>
                    {{-- @endcananny --}}
                ...
                <li class="menu-title">SALESPERSON</li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-layout"></i>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        {{-- @can('user_manage') --}}
                        <li><a href="{{ route('sales-person.add.view') }}">Add New Salesperson</a></li>
                        {{-- @endcan
                        @can('user_listing') --}}
                        <li><a href="{{ route('sales-person.index') }}">Salesperson Listing</a></li>
                        {{-- @endcan --}}
                    </ul>
                </li>
